...
export default {
  ...
  mounted() {
    this.getBonusPolicyContent();
  },
  methods: {
    async getBonusPolicyContent() {
      this.isLoading = true;
      try {
        const res = await axios.get('https://www.playeroffers.com/api.php?sid=7f73ab615f196b7f63b49fbdbbee82eb&type=bonus_policy&lang=en');
